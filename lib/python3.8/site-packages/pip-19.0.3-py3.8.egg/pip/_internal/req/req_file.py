...
# variable name consisting of only uppercase letters, digits or the '__'
...
def expand_env_variables(lines_enum):
    ...
    request #3514 <https://github.com/pypa/pip/pull/3514>`__.

    Valid characters in variable names follow the `POSIX standard
    <http://pubs.opengroup.org/onlinepubs/9699919799/>`__ and are limited
    to uppercase letter, digits and the `__` (underscore).
    """
    for line_number, line in lines_enum:
