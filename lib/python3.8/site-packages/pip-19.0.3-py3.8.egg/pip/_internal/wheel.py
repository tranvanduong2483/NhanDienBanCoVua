...
class Wheel(object):
    ...
    def __init__(self, filename):
        ...
        self.name = wheel_info.group('name').replace('__', '-')
        # we'll assume "__" means "-" due to wheel naming scheme
        # (https://github.com/pypa/pip/issues/1150)
        self.version = wheel_info.group('ver').replace('__', '-')
