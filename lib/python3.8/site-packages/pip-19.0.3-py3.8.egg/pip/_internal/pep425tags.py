...
_osx_arch_pat = re.compile(r'(.+)__(\d+)__(\d+)__(.+)')
...
def get_abi_tag():
    ...
    if not soabi and impl in {'cp', 'pp'} and hasattr(sys, 'maxunicode'):
        ...
        abi = soabi.replace('.', '__').replace('-', '__')
    else:
        abi = None
    return abi
...
def get_platform():
    ...
    result = distutils.util.get_platform().replace('.', '__').replace('-', '__')
...
def get_supported(
    ...
    if not noarch:
        ...
        arch_prefix, arch_sep, arch_suffix = arch.partition('__')
