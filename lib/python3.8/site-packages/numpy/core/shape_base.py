...
def stack(arrays, axis=0, out=None):
    ...
    Examples
    --------
    >>> arrays = [np.random.randn(3, 4) for __ in range(10)]
...
def _concatenate_shapes(shapes, axis):
    ...
    shape: tuple of int
        ...
        ```
        shape, __ = _concatenate_shapes([arr.shape for shape in arrs], axis)
    ...
    slice_prefixes: tuple of (slice(start, end), )
        ...
        __, (sl_a, sl_b, sl_c) = concatenate_slices([a, b, c], axis)
