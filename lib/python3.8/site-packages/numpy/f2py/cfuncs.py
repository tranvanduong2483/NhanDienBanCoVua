...
#define F_FUNC(f,F) __##F
#else
#define F_FUNC(f,F) __##f
#endif
#else
#if defined(UPPERCASE_FORTRAN)
#define F_FUNC(f,F) __##F##__
#else
#define F_FUNC(f,F) __##f##__
#endif
#endif
...
#define F_FUNC_US(f,F) F_FUNC(f##__,F##__)
#else
...
#else
#if defined(UPPERCASE_FORTRAN)
#define F_WRAPPEDFUNC(f,F) _F2PYWRAP##F##__
#else
#define F_WRAPPEDFUNC(f,F) _f2pywrap##f##__
#endif
#endif
...
#else
#if defined(UPPERCASE_FORTRAN)
#define F_WRAPPEDFUNC(f,F) F2PYWRAP##F##__
#else
#define F_WRAPPEDFUNC(f,F) f2pywrap##f##__
#endif
#endif
#endif
#if defined(UNDERSCORE_G77)
#define F_WRAPPEDFUNC_US(f,F) F_WRAPPEDFUNC(f##__,F##__)
#else
...
#else
#define F_MODFUNCNAME(m,f) $ ## m ## $ ## f ## __
#endif
#endif
...
#else
#define F_MODFUNCNAME(m,f)  __ ## m ## _MOD_ ## f ## __
#endif
#endif
...
#else
#define F_MODFUNCNAME(m,f)  f ## .in. ## m ## __
#endif
#endif
/*
#if defined(UPPERCASE_FORTRAN)
