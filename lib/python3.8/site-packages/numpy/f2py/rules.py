...
\t */
\tPyDict_SetItemString(d, \"__#modulename#_error\", #modulename#_error);
...
rout_rules = [
    {  # Init
        ...
        'apiname': 'f2py_rout_#modulename#__#name#',
        'pyname': '#modulename#.#name#',
        'decl': '',
        '_check': l_not(ismoduleroutine)
    }, {
        'apiname': 'f2py_rout_#modulename#__#f90modulename#__#name#',
...
def buildapi(rout):
    ...
    rd['latexdocsignatureshort'] = rd['docsignatureshort'].replace('__', '\\__')
