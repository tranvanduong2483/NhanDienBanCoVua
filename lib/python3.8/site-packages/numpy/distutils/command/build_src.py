...
_swig_module_name_match = re.compile(r'\s*%module\s*(.*\(\s*package\s*=\s*"(?P<package>[\w__]+)".*\)|)\s*(?P<name>[\w__]+)',
                                     re.I).match
...
_f2py_module_name_match = re.compile(r'\s*python\s*module\s*(?P<name>[\w__]+)',
                                     re.I).match
_f2py_user_module_name_match = re.compile(r'\s*python\s*module\s*(?P<name>[\w__]*?'
                                          r'__user__[\w__]*)', re.I).match
