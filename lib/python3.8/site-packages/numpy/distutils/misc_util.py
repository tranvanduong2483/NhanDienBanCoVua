...
f90_module_name_match = re.compile(r'\s*module\s*(?P<name>[\w__]+)', re.I).match
...
class Configuration(object):
    ...
    def _get_configuration_from_setup_py(self, setup_py,
        ...
        try:
            ...
            setup_module = npy_load_module('__'.join(n.split('.')),
                                           setup_py,
                                           ('.py', 'U', 1))
    ...
    def get_version(self, version_file=None, version_variable=None):
        ...
        for f in files:
            ...
            if os.path.isfile(fn):
                ...
                try:
                    version_module = npy_load_module('__'.join(n.split('.')),
                                                     fn, info)
                except ImportError:
                    msg = get_exception()
                    self.warn(str(msg))
        ...
        f.write(textwrap.dedent(r'''
            ...
            def show():
                for name,info_dict in globals().items():
                    if name[0] == "__" or type(info_dict) is not type({}): continue
                    print(name + ":")
                    if not info_dict:
                        print("  NOT AVAILABLE")
