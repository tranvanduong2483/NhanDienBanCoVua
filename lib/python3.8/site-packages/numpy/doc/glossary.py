...
.. glossary::
   ...
   BLAS
       `Basic Linear Algebra Subprograms <https://en.wikipedia.org/wiki/Basic_Linear_Algebra_Subprograms>`__
   ...
   list
       ...
       tutorial <https://docs.python.org/tutorial/>`__.  For a mapping
