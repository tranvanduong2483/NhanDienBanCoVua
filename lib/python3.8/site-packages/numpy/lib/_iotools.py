...
class NameValidator(object):
    ...
    are replaced by '__'. During instantiation, the user can define a list
    of names to exclude, as well as a list of invalid characters. Names in
    the exclusion list are appended a '__' character.
    ...
    def __init__(self, excludelist=None, deletechars=None,
                 case_sensitive=None, replace_space='__'):
    ...
    def validate(self, names, defaultfmt="f%i", nbfields=None):
        ...
        for item in names:
            ...
            cnt = seen.get(item, 0)
            if cnt > 0:
                validatednames.append(item + '__%d' % cnt)
            else:
