...
def gradient(f, *varargs, **kwargs):
    ...
    .. [3]  Fornberg B. (1988) Generation of Finite Difference Formulas on
            ...
            S0025-5718-1988-0935077-0/S0025-5718-1988-0935077-0.pdf>`__.
    """
    f = np.asanyarray(f)
...
class vectorize(object):
    ...
    .. [1] NumPy Reference, section `Generalized Universal Function API
           <https://docs.scipy.org/doc/numpy/reference/c-api.generalized-ufuncs.html>`__.
...
def i0(x):
    ...
    We use the algorithm published by Clenshaw [1]__ and referenced by
    Abramowitz and Stegun [2]__, for which the function domain is
    partitioned into the two intervals [0,8] and (8,inf), and Chebyshev
    polynomial expansions are employed in each interval. Relative error on
    the domain [0,30] using IEEE arithmetic is documented [3]__ as having a
...
def trapz(y, x=None, dx=1.0, axis=-1):
    ...
    Notes
    -----
    Image [2]__ illustrates trapezoidal rule -- y-axis locations of points
