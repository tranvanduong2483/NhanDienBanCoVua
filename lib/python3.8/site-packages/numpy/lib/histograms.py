...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    >>> hist_0, __ = np.histogram(arr[group_id == 0], bins=shared_bins)
    >>> hist_1, __ = np.histogram(arr[group_id == 1], bins=shared_bins)
...
def histogram(a, bins=10, range=None, normed=None, weights=None,
    ...
    *includes* 4.
    ...
    >>> __ = plt.hist(a, bins='auto')  # arguments are passed to np.histogram
